...
export const partners: Partner[] = [
  ...
  { name: 'Rabby',         logo: '/logos/partners/logo-white 1.svg',         userTypes: ['single-chain-wallet'],   featured: true },
  ...
  { name: 'KyberSwap',     logo: '/logos/partners/kyberswap-text-white 1.svg', userTypes: ['dex'],                   featured: true },
