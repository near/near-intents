...
export const chains: Chain[] = [
  ...
  { slug: 'berachain',   name: 'Berachain',    logo: 'https://coin-images.coingecko.com/coins/images/50819/small/BERA_icon_beige.png', color: '#964B00' },
  ...
  // Other L1s
  { slug: 'near',        name: 'NEAR',         logo: 'https://coin-images.coingecko.com/coins/images/10365/small/near_icon.png',      color: '#00EC97' },
  ...
  { slug: 'stellar',     name: 'Stellar',      logo: 'https://coin-images.coingecko.com/coins/images/100/small/Stellar_symbol_black_RGB.png', color: '#7D00FF' },
