...
export const chains: Chain[] = [
  // EVM
  // EVM — exact URLs from near-intents-std chainLogos
  ...
  { slug: 'base',        name: 'Base',         logo: 'https://coin-images.coingecko.com/asset_platforms/images/131/small/base.jpeg',             color: '#0052FF' },
  ...
  { slug: 'berachain',   name: 'Berachain',    logo: 'https://coin-images.coingecko.com/coins/images/25235/large/BERA.png',                      color: '#964B00' },
  { slug: 'scroll',      name: 'Scroll',       logo: 'https://coin-images.coingecko.com/asset_platforms/images/153/small/scroll.jpeg',           color: '#F5C55E' },
  ...
  { slug: 'xlayer',      name: 'XLayer',       logo: 'https://coin-images.coingecko.com/coins/images/4463/small/WeChat_Image_20220118095654.png', color: '#333333' },
  { slug: 'aleo',        name: 'Aleo',         logo: 'https://coin-images.coingecko.com/coins/images/27916/large/secondary-icon-dark.png',       color: '#00C0F9' },
  { slug: 'adi',         name: 'ADI',          logo: 'https://coin-images.coingecko.com/coins/images/38803/small/adi.jpeg',                      color: '#C4A962' },
];
