...
export function ConfidentialCTAV2() {
    ...
    <footer ref={sectionRef} className="py-8 md:py-12 px-8 md:px-20 pb-32 bg-[#0A0D14] relative">
      ...
      <div className="max-w-7xl mx-auto relative z-10 pb-20">
        ...
        <div ref={buttonsRef} className="flex flex-wrap gap-4">
          ...
          >
            Go confidential on near.com
          </button>
          <button
            className="px-8 py-4 border-2 border-white/20 text-white font-bold rounded-lg hover:border-brand-orange-500/60 hover:text-brand-orange-500 transition-all duration-300"
            onClick={() => window.open('https://t.me/near_intents', '_blank')}
          >
            Talk with the team
          </button>
        </div>
