      ...
      <div className="max-w-7xl mx-auto">
        <RevealOnScroll>
          <div className="mb-8 md:mb-16">
            <h2 className="text-2xl md:text-4xl font-bold mb-6 tracking-tight text-white">How it works</h2>
            <div className="w-full h-px bg-gradient-to-r from-brand-orange-500 to-transparent my-6"></div>
            <p className="text-zinc-400 leading-relaxed mb-8 text-base md:text-[18px] max-w-2xl">
