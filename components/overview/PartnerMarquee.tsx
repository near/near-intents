...
export default function PartnerMarquee() {
  ...
  return (
    <section className="bg-white/[0.18] py-6 overflow-hidden border-t border-white/10">
      <p className="text-center text-xs font-medium uppercase tracking-widest text-white/40 mb-5">
